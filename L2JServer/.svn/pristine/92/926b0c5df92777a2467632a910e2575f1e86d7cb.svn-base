...
public final class Location implements IPositionable
{
	...
	/* (non-Javadoc)
	 * @see com.l2jserver.gameserver.model.interfaces.ILocational#getLocation()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.l2jserver.gameserver.model.interfaces.IPositionable#setXYZ(int, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.l2jserver.gameserver.model.interfaces.IPositionable#setXYZ(com.l2jserver.gameserver.model.interfaces.ILocational)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.l2jserver.gameserver.model.interfaces.IPositionable#setLocation(com.l2jserver.gameserver.model.Location)
	 */
	@Override

...
public final class Config
{
	...
	//--------------------------------------------------
	// Donovan Property File Definitions
	//--------------------------------------------------
    ...
    public static final String VOTEREWARD_CONFIG_FILE = "./config/VoteReward.properties";
    public static final String PARTYCONTROL_CONFIG_FILE = "./config/partycontrol.properties";    
    
    
	//For Buff Scheme 
	public static final String PROJECT_NAME = "Donovan";

	public static final String ENCHANT_CHANCE = null;
	...
	//--------------------------------------------------
			...
			public static boolean ENABLE_GM_SHOP_CB;
			public static boolean ONLY_USE_SHOP_PEACE_ZONE;
			public static boolean ENABLE_GK_GLOBAL_CB;
			public static boolean ONLY_USE_GK_PEACE_ZONE;
			public static boolean ENABLE_CLASS_MASTER_CB;
			public static boolean ONLY_USE_CLASS_MASTER_PEACE_ZONE;
			public static boolean ENABLE_BUFFER_CB;
			public static boolean ONLY_USE_BUFFER_PEACE_ZONE;
			public static boolean ENABLE_AUGMENT_CB;
			public static boolean ONLY_USE_AUGMENT_PEACE_ZONE;
			

			public static boolean ENABLE_HOME;
			public static boolean ENABLE_FAVORITE;
			public static boolean ENABLE_HOMEPAGE;
			public static boolean ENABLE_REGION;
			public static boolean ENABLE_CLAN;
			public static boolean ENABLE_MAIL;
			public static boolean ENABLE_FRIENDS;
			
			public static FastMap<Integer, Integer> CB_SKILLS_PROPHET;
			public static FastMap<Integer, Integer> CB_SKILLS_ELDER;
			public static FastMap<Integer, Integer> CB_SKILLS_S_ELDER;
			public static FastMap<Integer, Integer> CB_SKILLS_OVERLORD;
			public static FastMap<Integer, Integer> CB_SKILLS_WARCRY;
			public static FastMap<Integer, Integer> CB_SKILLS_S_SINGER;
			public static FastMap<Integer, Integer> CB_SKILLS_B_DANCER;
			public static FastMap<Integer, Integer> CB_SKILLS_OTHER;


	//--------------------------------------------------
	// Donovan Variable Definitions
	//--------------------------------------------------
	...
	public static int REPUTATION_QUANTIT;
	...
	public static int    CLAN_LEADER_TITLE;
 	public static int    CLAN_LEADER_TITLE_CLAN_LEVEL;
        ...
        public static boolean SELL_BUFF_ENABLED;
        	...
        	public static int STORE_SELL_CURRENCY_BUFF;
	...
	public static boolean VOTE_SYSTEM_TOPZONE;
	public static boolean VOTE_SYSTEM_BRASIL;
	public static boolean VOTE_SYSTEM_ADMINSPRO;
	public static String VOTE_SYSTEM_PAGE_HOPZONE;
	public static String VOTE_SYSTEM_PAGE_TOPZONE;
	public static String VOTE_SYSTEM_PAGE_BRASIL;
	public static String VOTE_SYSTEM_PAGE_ADMINSPRO;
	public static int VOTE_SYSTEM_COUNT;
	public static int VOTE_SYSTEM_CHECK_TIME;
	public static String VOTE_SYSTEM_ITEM_ID_HOPZONE;
	public static String VOTE_SYSTEM_ITEM_COUNT_HOPZONE;
	public static String VOTE_SYSTEM_ITEM_ID_TOPZONE;
	public static String VOTE_SYSTEM_ITEM_COUNT_TOPZONE;
	public static String VOTE_SYSTEM_ITEM_ID_BRASIL;
	public static String VOTE_SYSTEM_ITEM_COUNT_BRASIL;
	public static String VOTE_SYSTEM_ITEM_ID_ADMINSPRO;
	public static String VOTE_SYSTEM_ITEM_COUNT_ADMINSPRO;
	public static boolean VOTE_GLOBAL;
	...
	public static boolean COMBINETALISMANS;
	public static boolean CHANGENAME;
	public static boolean PING;
	public static boolean CLANMENSAJE;
	public static boolean RES;
	public static boolean DESCONECTAR;
	public static boolean SIEGE;
	public static boolean DEBUFF;
	public static boolean CLAN_SET;
	public static boolean VOTE_INDIVIDUAL;
	public static boolean GO_LIDER_CLAN;
	public static boolean TOMOS;
	public static boolean DELEVEL;
	public static boolean DRESSME;
	 ...
	 public static int VIP_SP;
	     public static int VIP_DROP_ITEM_ID;
	     public static int VIP_DROP_ITEM_REWARD;
	     public static int VIP_DROP_ITEM_QTY;
	...
	public static String    CUSTOM_CHAR_TITLE_TEXT2;
		...
		if(Server.serverMode == Server.MODE_GAMESERVER)
		{
			...
			try
			{
				...
				catch (Exception e)
				{
				 ...
				 try
	             {
		             L2Properties partycontrol  = new L2Properties();
		             is = new FileInputStream(new File(PARTYCONTROL_CONFIG_FILE));
...
ANNOUNCE_CASTLE_LORD = Boolean.parseBoolean(Character.getProperty("AnnounceCastleLord", "False"));
				...
				// Load Donovan Server Version L2Properties file (if exists)
				try
				{
				...
				// Load Donovan Datapack Version L2Properties file (if exists)
				try
				{
					L2Properties serverVersion = new L2Properties();
				...
				// Load Donovan Mod L2Properties file (if exists)
				try
				{
					...
					// Setting Party
					MAX_PARTY_MEMBERS = Integer.parseInt(L2JModSettings.getProperty("MaxPartyMembers", "10"));
			...
			// AutoVoteReward
			VOTE_GLOBAL = Boolean.parseBoolean(VoteRewardSettings.getProperty("EnableVoteGlobal", "False"));
			...
			VOTE_SYSTEM_ENABLE = Boolean.parseBoolean(VoteRewardSettings.getProperty("EnableVoteSystem", "False"));
			VOTE_SYSTEM_HOPZONE = Boolean.parseBoolean(VoteRewardSettings.getProperty("VoteSystemHopzone", "False"));
			VOTE_SYSTEM_TOPZONE = Boolean.parseBoolean(VoteRewardSettings.getProperty("VoteSystemTopzone", "False"));
			VOTE_SYSTEM_BRASIL = Boolean.parseBoolean(VoteRewardSettings.getProperty("VoteSystemBrasil", "False"));
			VOTE_SYSTEM_ADMINSPRO = Boolean.parseBoolean(VoteRewardSettings.getProperty("VoteSystemAdminsPro", "False"));
			VOTE_SYSTEM_COUNT = Integer.parseInt(VoteRewardSettings.getProperty("VoteSystemVotes", "10"));
			VOTE_SYSTEM_CHECK_TIME = Integer.parseInt(VoteRewardSettings.getProperty("VoteSystemRunCheckTime", "120"));
			// Hopzone
			VOTE_SYSTEM_PAGE_HOPZONE = VoteRewardSettings.getProperty("VoteSystemPageHopzone", "");
			VOTE_SYSTEM_ITEM_ID_HOPZONE = VoteRewardSettings.getProperty("VoteSystemItemIdHopzone", "57, 1000");
			VOTE_SYSTEM_ITEM_COUNT_HOPZONE = VoteRewardSettings.getProperty("VoteSystemItemCountHopzone", "1000, 1");
			// Topzone
			VOTE_SYSTEM_PAGE_TOPZONE = VoteRewardSettings.getProperty("VoteSystemPageTopzone", "");
			VOTE_SYSTEM_ITEM_ID_TOPZONE = VoteRewardSettings.getProperty("VoteSystemItemIdTopzone", "57, 1000");
			VOTE_SYSTEM_ITEM_COUNT_TOPZONE = VoteRewardSettings.getProperty("VoteSystemItemCountTopzone", "1000, 1");
			// TopBrasil
			VOTE_SYSTEM_PAGE_BRASIL = VoteRewardSettings.getProperty("VoteSystemPageBrasil", "");
			VOTE_SYSTEM_ITEM_ID_BRASIL = VoteRewardSettings.getProperty("VoteSystemItemIdBrasil", "57, 1000");
			VOTE_SYSTEM_ITEM_COUNT_BRASIL = VoteRewardSettings.getProperty("VoteSystemItemCountBrasil", "1000, 1");
			// TopAdminsPro
			VOTE_SYSTEM_PAGE_ADMINSPRO = VoteRewardSettings.getProperty("VoteSystemPageAdminsPro", "");
			VOTE_SYSTEM_ITEM_ID_ADMINSPRO = VoteRewardSettings.getProperty("VoteSystemItemIdAdminsPro", "57, 1000");
			VOTE_SYSTEM_ITEM_COUNT_ADMINSPRO = VoteRewardSettings.getProperty("VoteSystemItemCountAdminsPro", "1000, 1");
		
			VOTE_LINK_HOPZONE = VoteRewardSettings.getProperty("HopzoneUrl", "null");
			VOTE_LINK_TOPZONE = VoteRewardSettings.getProperty("TopzoneUrl", "null");
			VOTE_REWARD_ID1 = Integer.parseInt(VoteRewardSettings.getProperty("VoteRewardId1", "300"));
			VOTE_REWARD_ID2 = Integer.parseInt(VoteRewardSettings.getProperty("VoteRewardId2", "300"));
			VOTE_REWARD_ID3 = Integer.parseInt(VoteRewardSettings.getProperty("VoteRewardId3", "300"));
			VOTE_REWARD_ID4 = Integer.parseInt(VoteRewardSettings.getProperty("VoteRewardId4", "300"));
			VOTE_REWARD_AMOUNT1 = Integer.parseInt(VoteRewardSettings.getProperty("VoteRewardAmount1", "300"));
			VOTE_REWARD_AMOUNT2 = Integer.parseInt(VoteRewardSettings.getProperty("VoteRewardAmount2", "300"));
			VOTE_REWARD_AMOUNT3 = Integer.parseInt(VoteRewardSettings.getProperty("VoteRewardAmount3", "300"));
			VOTE_REWARD_AMOUNT4 = Integer.parseInt(VoteRewardSettings.getProperty("VoteRewardAmount4", "300"));
			SECS_TO_VOTE = Integer.parseInt(VoteRewardSettings.getProperty("SecondsToVote", "20"));
			EXTRA_REW_VOTE_AM = Integer.parseInt(VoteRewardSettings.getProperty("ExtraRewVoteAm", "20"));
					...
					RESTART_BY_TIME_OF_DAY = Boolean.parseBoolean(L2JModSettings.getProperty("EnableRestartSystem", "False"));
		 	 	 	RESTART_SECONDS = Integer.parseInt(L2JModSettings.getProperty("RestartSeconds", "360"));
	                         	RESTART_INTERVAL_BY_TIME_OF_DAY = L2JModSettings.getProperty("RestartByTimeOfDay", "20:00").split(",");
			       ...
			       REC_BUY = Boolean.parseBoolean(L2JModSettings.getProperty("AlowBuyRec", "True"));
			       REC_ITEM_ID = Integer.parseInt(L2JModSettings.getProperty("RecItemID", "57"));
 			       REC_PRICE = Integer.parseInt(L2JModSettings.getProperty("RecPrice", "50000000"));
 			       REC_REWARD = Integer.parseInt(L2JModSettings.getProperty("RecReward", "1"));
 			       COMMAND_ONLINE = Boolean.parseBoolean(L2JModSettings.getProperty("CommandOnline", "False"));
			       ALLOW_EXP_GAIN_COMMAND = Boolean.parseBoolean(L2JModSettings.getProperty("AllowExpGainCommand", "false"));
			       ALLOW_TELEPORT_VOICECOMMAND = Boolean.parseBoolean(L2JModSettings.getProperty("UpLevel", "True"));
    		       CMD_FAKE = Boolean.parseBoolean(L2JModSettings.getProperty("CommandFakePlayer", "false"));
    		       FAKE_PLAYERS = Integer.parseInt(L2JModSettings.getProperty("NumberOfFakes", "1"));
    		       BOSS_STATS = Boolean.parseBoolean(L2JModSettings.getProperty("GrandBossStats", "false"));
					...
					STORE_SELL_CURRENCY = Integer.parseInt(L2JModSettings.getProperty("PrivateStoreSellMoneda", "57"));
                        ALT_GAME_FLAGED_PLAYER_CAN_USE_GK = Boolean.parseBoolean(L2JModSettings.getProperty("AltFlagedPlayerCanUseGK", "false"));
                               DAY_TO_SIEGE = Integer.parseInt(L2JModSettings.getProperty("DayToSiege", "14"));		
L2JMOD_WEDDING_DIVORCE_COSTS = Integer.parseInt(L2JModSettings.getProperty("WeddingDivorceCosts", "20"));
              OFFLINE_TRADE_EFFECTO = Boolean.parseBoolean(L2JModSettings.getProperty("OfflineTradeEffecto", "False"));
              OFFLINE_EFFECTO_ID = Integer.parseInt(L2JModSettings.getProperty("OfflineEffectoId", "1"));

                      CLAN_LEADER_COLOR_ENABLED = Boolean.parseBoolean(L2JModSettings.getProperty("ClanLeaderNameColorEnabled", "False"));
                CLAN_LEADER_COLOR = Integer.decode("0x" + L2JModSettings.getProperty("ClanLeaderColor", "00BFFF"));
                CLAN_LEADER_COLOR_CLAN_LEVEL = Integer.parseInt(L2JModSettings.getProperty("ClanLeaderColorAtClanLevel", "1"));
                      CLAN_LEADER_TITLE_ENABLED = Boolean.parseBoolean(L2JModSettings.getProperty("ClanLeaderTitleColorEnabled", "False"));
                CLAN_LEADER_TITLE = Integer.decode("0x" + L2JModSettings.getProperty("ClanLeaderTitle", "00BFFF"));
                CLAN_LEADER_TITLE_CLAN_LEVEL = Integer.parseInt(L2JModSettings.getProperty("ClanLeaderTitleAtClanLevel", "1"));

                    ENABLE_COLOR_PVP = Boolean.parseBoolean(L2JModSettings.getProperty("EnableColorPvP", "False"));
                    COLOR_PVP_100 = Integer.decode("0x" + L2JModSettings.getProperty("ColorPvP1", "00FF00"));
                    COLOR_PVP_500 = Integer.decode("0x" + L2JModSettings.getProperty("ColorPvP2", "00FF00"));
                    COLOR_PVP_1000 = Integer.decode("0x" + L2JModSettings.getProperty("ColorPvP3", "00FF00"));
                    COLOR_PVP_5000 = Integer.decode("0x" + L2JModSettings.getProperty("ColorPvP4", "00FF00"));
                    ENABLE_COLOR_PK = Boolean.parseBoolean(L2JModSettings.getProperty("EnableColorPk", "False"));
                    COLOR_PK_100 = Integer.decode("0x" + L2JModSettings.getProperty("ColorPk1", "00FF00"));
                    COLOR_PK_500 = Integer.decode("0x" + L2JModSettings.getProperty("ColorPk2", "00FF00"));
                    COLOR_PK_1000 = Integer.decode("0x" + L2JModSettings.getProperty("ColorPk3", "00FF00"));
                    COLOR_PK_5000 = Integer.decode("0x" + L2JModSettings.getProperty("ColorPk4", "00FF00"));
                  
                 	OLYMPIAD_PERIOD = L2JModSettings.getProperty("CustomOlyPeriod", "MONTH");
                	String[] times = L2JModSettings.getProperty("AltOlyEndHour", "12:00:00").split(":");
                			for (int i = 0; i < 3; i++)
                			{
                            ...
                            {
                                String AioSkillsSplit[] = L2JModSettings.getProperty("ClanSkills", "").split(";");
                            ...
                            if(skillSplit.length != 2)
                            {
                                System.out.println((new StringBuilder()).append("[Clan System]: invalid config property in config/L2JMods.properties -> ClanSkills \"").append(skill).append("\"").toString());
                                continue;
                            }
                            try
                            {
                            ...
                            if(!skill.equals(""))
                                System.out.println((new StringBuilder()).append("[Clan System]: invalid config property in config/L2JMods.properties -> ClanSkills \"").append(skillSplit[0]).append("\"").append(skillSplit[1]).toString());
                            }
                            }
                            CLAN_LEVEL = Byte.parseByte(L2JModSettings.getProperty("ClanSetLevel", "8"));
                            REPUTATION_QUANTITY = Integer.parseInt(L2JModSettings.getProperty("ReputationScore", "10000"));
                            BREAK_ENCHANT = Integer.valueOf(L2JModSettings.getProperty("BreakEnchant", "0"));

                            PING = Boolean.parseBoolean(L2JModSettings.getProperty("Ping", "false"));
                            CHANGENAME = Boolean.parseBoolean(L2JModSettings.getProperty("ChangeName", "false"));
                            COMBINETALISMANS = Boolean.parseBoolean(L2JModSettings.getProperty("CombineTalismans", "false"));
                            CLANMENSAJE = Boolean.parseBoolean(L2JModSettings.getProperty("ClanMensaje", "false"));
                            RES = Boolean.parseBoolean(L2JModSettings.getProperty("Res", "false"));
                            DESCONECTAR = Boolean.parseBoolean(L2JModSettings.getProperty("Desconectar", "false"));
                            SIEGE = Boolean.parseBoolean(L2JModSettings.getProperty("Siege", "false"));
                            DEBUFF = Boolean.parseBoolean(L2JModSettings.getProperty("Debuff", "false"));
                            CLAN_SET = Boolean.parseBoolean(L2JModSettings.getProperty("ClanSet", "false"));
                            VOTE_INDIVIDUAL = Boolean.parseBoolean(L2JModSettings.getProperty("VoteIndividual", "false"));
                            GO_LIDER_CLAN = Boolean.parseBoolean(L2JModSettings.getProperty("GoLiderClan", "false"));
                            TOMOS = Boolean.parseBoolean(L2JModSettings.getProperty("Tomos", "false"));
                            DELEVEL = Boolean.parseBoolean(L2JModSettings.getProperty("Delevel", "false"));
                            DRESSME = Boolean.parseBoolean(L2JModSettings.getProperty("Dressme", "false"));

                            ENABLE_ALL_EXCEPTIONS = Boolean.parseBoolean(L2JModSettings.getProperty("EnableAllExceptionsLog", "false"));
                            
                            			// TODO: Command Sell Buff
                        	SELL_BUFF_ENABLED = Boolean.parseBoolean(L2JModSettings.getProperty("SellBuffEnabled", "True"));
                        	        				if(SELL_BUFF_ENABLED) //create map if system is enabled
                        	        	        	{
                        	        	        		SELL_BUFF_SKILL_LIST = new FastMap<Integer, Integer>();
                        	        	
                        	        					String[] propertySplit;
                        	        					propertySplit = L2JModSettings.getProperty("SellBuffSkillList", "").split(";");
                        	        	        	...
                        	        	        	if(SELL_BUFF_ENABLED) //create map if system is enabled
                        	        	        	{
                        	        	        		String SELL_BUFF_CLASS_STRING = L2JModSettings.getProperty("SellBuffClassList");
                        	        	        		int i=0;
                        	        	        	...
                        	        	        	ALLOW_PARTY_BUFFS = Boolean.parseBoolean(L2JModSettings.getProperty("AllowPartyBuffs", "True"));
                        	        	        	ALLOW_CLAN_BUFFS = Boolean.parseBoolean(L2JModSettings.getProperty("AllowClanBuffs", "True"));
                        	        	        	SELL_BUFF_PUNISHED_PRICE = Integer.parseInt(L2JModSettings.getProperty("SellBuffPunishedPrice", "10000"));
                        	        	        	SELL_BUFF_FILTER_ENABLED = Boolean.parseBoolean(L2JModSettings.getProperty("SellBuffFilterEnabled", "True"));
                        	        	        	
                        	        	        	SELL_BUFF_MIN_LVL = Integer.parseInt(L2JModSettings.getProperty("SellBuffMinLvl", "20"));
                        	        	        	SELL_BUFFSET_ENABLED = Boolean.parseBoolean(L2JModSettings.getProperty("SellBuffsetEnabled", "True"));
                        	        	        	
                        	        	        	SELL_BUFFSET_MIN_LVL = Integer.parseInt(L2JModSettings.getProperty("SellBuffSetMinLvl", "79"));
                        	        	        	...
                        	        	        	if(SELL_BUFFSET_ENABLED) //create map if system is enabled
                        	        	        	{
                        	        	        		...
                        	        	        		tempStr = L2JModSettings.getProperty("SellBuffsetWarrior");
                        	        	        		i=0;
                        	        	        		for(String skillId : tempStr.split(",")){
                        	        	        			SELL_BUFFSET_WARRIOR.add(i,skillId);
                        	        	        			i++;
                        	        	        		}
                        	        	        		tempStr = L2JModSettings.getProperty("SellBuffsetMage");
                        	        	        		i=0;
                        	        	        		for(String skillId : tempStr.split(",")){
                        	        	        			SELL_BUFFSET_MAGE.add(i,skillId);
                        	        	        			i++;
                        	        	        		}
                        	        	        		tempStr = L2JModSettings.getProperty("SellBuffsetRecharger");
                        	        	        		i=0;
                        	        	        		for(String skillId : tempStr.split(",")){
                        	        	        			SELL_BUFFSET_RECHARGER.add(i,skillId);
                        	        	        			i++;
                        	        	        		}
                        	        	        		tempStr = L2JModSettings.getProperty("SellBuffsetTanker");
                        	        	        		i=0;
                        	        	        		for(String skillId : tempStr.split(",")){
                        	        	        	...
                        	        	        	STORE_SELL_CURRENCY_BUFF = Integer.parseInt(L2JModSettings.getProperty("PrivateStoreSellMonedaBuff", "57"));
                        	        	        	OFFLINE_SELLBUFF_ENABLED = Boolean.parseBoolean(L2JModSettings.getProperty("OfflineSellbuffEnabled", "True"));
                        	        	        	SELL_BUFF_SKILL_MP_ENABLED = Boolean.parseBoolean(L2JModSettings.getProperty("SellBuffSkillMpEnabled", "False"));
                        	        	        	SELL_BUFF_SKILL_MP_MULTIPLIER = Double.parseDouble(L2JModSettings.getProperty("SellBuffSkillMpMultiplier", "1."));
                        	        	        	SELL_BUFF_SKILL_ITEM_CONSUME_ENABLED = Boolean.parseBoolean(L2JModSettings.getProperty("SellBuffSkillItemConsumeEnabled", "True"));
                        	        	        	//RESTRICTED ZONES IDS:
                        	        	    		int i = 0;
                        	        	    		String tempStr = L2JModSettings.getProperty("SellBuffRestrictedZonesIds");
				...
				// Sistema de recompensa de Item / Fama por PVP por Xander.-
				ITEM_REWARD_PVP_ENABLE = Boolean.parseBoolean(L2JModSettings.getProperty("ItemRewardPVP", "False"));
				ITEM_REWARD_ID_PVP = Integer.parseInt(L2JModSettings.getProperty("ItemRewardIDPVP", "57"));
				ITEM_REWARD_COUNT_PVP = Integer.parseInt(L2JModSettings.getProperty("ItemRewardCountPVP", "1000"));
				FAME_REWARD_PVP_ENABLE = Boolean.parseBoolean(L2JModSettings.getProperty("FameRewardPVP", "False"));
				FAME_REWARD_COUNT_PVP = Integer.parseInt(L2JModSettings.getProperty("FameRewardCountPVP", "100"));
				// Sistema de recompensa de Item / Fama por PK por Xander.-
				ITEM_REWARD_PK_ENABLE = Boolean.parseBoolean(L2JModSettings.getProperty("ItemRewardPK", "False"));
				ITEM_REWARD_ID_PK = Integer.parseInt(L2JModSettings.getProperty("ItemRewardIDPK", "57"));
				ITEM_REWARD_COUNT_PK = Integer.parseInt(L2JModSettings.getProperty("ItemRewardCountPK", "1000"));
				FAME_REWARD_PK_ENABLE = Boolean.parseBoolean(L2JModSettings.getProperty("FameRewardPK", "False"));
				FAME_REWARD_COUNT_PK = Integer.parseInt(L2JModSettings.getProperty("FameRewardCountPK", "100"));

					                          /** Custom Mods */
                          CUSTOM_CHAR_TITLE                      = Boolean.parseBoolean(L2JModSettings.getProperty("CustomStartTitle", "True"));
                          CUSTOM_CHAR_TITLE_TEXT                = L2JModSettings.getProperty("CustomTitleText","L2JBRASIL");
                          CUSTOM_CHAR_TITLE_TEXT2                = L2JModSettings.getProperty("CustomTitleText2","L2JBRASIL");
                          TITLE_COLOR                                  = Integer.decode("0x" + L2JModSettings.getProperty("TitleColor", "00FF00"));
                                       SHOW_WELCOME_PM = Boolean.parseBoolean(L2JModSettings.getProperty("ShowWelcomePM","True"));
                                       PM_FROM = L2JModSettings.getProperty("PMFrom", "L2J-Freya");
                                       PM_TEXT = L2JModSettings.getProperty("PMText", "Remember Vote For L2J-Freya");

					
                                   	// Achievment configurations
                                       			ENABLE_EVENT_ACHIEVEMENT = Boolean.parseBoolean(L2JModSettings.getProperty("AllowAchievement", "false"));
	...
	TVT_FRAGS_COUNTER = Boolean.parseBoolean(L2JModSettings.getProperty("TvTfragCountSystem", "false"));
	TVT_FRAGS_MIN_FOR_REWARD = Integer.parseInt(L2JModSettings.getProperty("TvTminFrags", "1"));
	TVT_EXTRA_REWARD_FOR_FRAGS = Boolean.parseBoolean(L2JModSettings.getProperty("TvTfragsExtraReward", "false"));
	TVT_EXTRA_REWARDS = new FastList<int[]>();
	TVT_FRAGS_MIN_FOR_EXTRA_REWARD = Integer.parseInt(L2JModSettings.getProperty("TvTminFragsExtra", "5"));
	TVT_FRAGS_FOR_REWARD_STEP = Integer.parseInt(L2JModSettings.getProperty("TvTfragsExtraStep", "5"));
	...
	//extrareward
	propertySplit = L2JModSettings.getProperty("TvTfragsExtraRewards", "5575,100000").split(";");
	for (String extrareward : propertySplit)
	{
	String[] extrarewardSplit = extrareward.split(",");
	if (extrarewardSplit.length != 2)
	_log.warning(StringUtil.concat("TvTEventEngine[Config.load()]: invalid config property -> TvTfragsExtraRewards \"", extrareward, "\""));
	else
	{
	try
	{
	TVT_EXTRA_REWARDS.add(new int[]{Integer.parseInt(extrarewardSplit[0]), Integer.parseInt(extrarewardSplit[1])});
	}
	catch (NumberFormatException nfe)
	{
	...
	//end extrareward
					...
					TW_TIME_BEFORE_START = Integer.parseInt(L2JModSettings.getProperty("TownWarTimeBeforeStart", "3600"));
					TW_RUNNING_TIME = Integer.parseInt(L2JModSettings.getProperty("TownWarRunningTime", "1800"));
					...
					TW_DISABLE_GK = Boolean.parseBoolean(L2JModSettings.getProperty("TownWarDisableGK", "True"));
               ...
               ANTIBOT_MIN_LEVEL = Integer.parseInt(L2JModSettings.getProperty("AntiBotMinLevel", "1"));
					...
					BUFFER_NPC_REMOVE_AMOUNT = Boolean.parseBoolean(L2JModSettings.getProperty("BufferNpcRemoveAmount", "false"));
										...
										USE_PREMIUMSERVICE = Boolean.parseBoolean(L2JModSettings.getProperty("UsePremiumServices", "False")); 
										PREMIUM_RATE_XP = Float.parseFloat(L2JModSettings.getProperty("PremiumRateXp", "2")); 
										PREMIUM_RATE_SP = Float.parseFloat(L2JModSettings.getProperty("PremiumRateSp", "2"));  
										PREMIUM_RATE_DROP_SPOIL = Float.parseFloat(L2JModSettings.getProperty("PremiumRateDropSpoil", "2")); 
										PREMIUM_RATE_DROP_ITEMS = Float.parseFloat(L2JModSettings.getProperty("PremiumRateDropItems", "2")); 
										PREMIUM_RATE_DROP_QUEST = Float.parseFloat(L2JModSettings.getProperty("PremiumRateDropQuest", "2"));
										PREMIUM_RATE_DROP_ITEMS_BY_RAID = Float.parseFloat(L2JModSettings.getProperty("PremiumRateRaidDropItems", "2"));
					 					
										String[] propertySplit = L2JModSettings.getProperty("RateDropItemsById", "").split(";");
...
//------------------------------- end------------------------------------------------------------------------//
                                                                        ...
                                                                        // -------------------- //
                                                                         ...
                                                                         VIP_SP = Integer.parseInt(L2JModSettings.getProperty("VipMulSp", "2"));
                                                                              VIP_DROP_ITEM_ID = Integer.parseInt(L2JModSettings.getProperty("VipDropItemID", "57"));
                                                                              VIP_DROP_ITEM_REWARD = Integer.parseInt(L2JModSettings.getProperty("VipDropItemReward", "57"));
                                                                              VIP_DROP_ITEM_QTY = Integer.parseInt(L2JModSettings.getProperty("VipDropItemCount", "57"));
                                                                              RATE_DROP_VIP = Integer.parseInt(L2JModSettings.getProperty("VipDropRate", "2"));
                                                                        ...
                                                                        ALLOW_AIO_BLOCK_EVENT = Boolean.parseBoolean(L2JModSettings.getProperty("AllowAioEvent", "False"));
                                                                        ALLOW_AIO_USE_GK = Boolean.parseBoolean(L2JModSettings.getProperty("AllowAioUseGk", "False"));
                                                                        ...
                                                                        {
                                                                        	String property = L2JModSettings.getProperty("AioSkills", "").trim();
                                                                        	if (!property.isEmpty()) {
                                                                        	    String[] AioSkillsSplit = property.split(";");
                                                                        	    ...
                                                                        	    for (String skill : AioSkillsSplit) {
                                                                        	        ...
                                                                        	        if (skillSplit.length != 2) {
                                                                        	            ...
                                                                        	            try {
                                                                        	                ...
                                                                        	                System.out.println("[Aio System]: invalid number format in AioSkills \"" + skill + "\"");
                                                                        	            }
                                                                        	        }
                                                                        	    }
                                                                        	} else {
                                                                        	    AIO_SKILLS = new FastMap<>(0); // simplemente no carga nada
                                                                        	}                                
					...
					RANK_ARENA_ENABLED = Boolean.parseBoolean(L2JModSettings.getProperty("RankArenaEnabled", "false"));
					RANK_ARENA_INTERVAL = Integer.parseInt(L2JModSettings.getProperty("RankArenaInterval", "120"));
					RANK_ARENA_REWARD_ID = Integer.parseInt(L2JModSettings.getProperty("RankArenaRewardId", "57"));
					RANK_ARENA_REWARD_COUNT = Integer.parseInt(L2JModSettings.getProperty("RankArenaRewardCount", "100"));
					
					RANK_FISHERMAN_ENABLED = Boolean.parseBoolean(L2JModSettings.getProperty("RankFishermanEnabled", "false"));
					RANK_FISHERMAN_INTERVAL = Integer.parseInt(L2JModSettings.getProperty("RankFishermanInterval", "120"));
					RANK_FISHERMAN_REWARD_ID = Integer.parseInt(L2JModSettings.getProperty("RankFishermanRewardId", "57"));
					RANK_FISHERMAN_REWARD_COUNT = Integer.parseInt(L2JModSettings.getProperty("RankFishermanRewardCount", "100"));
					
					RANK_CRAFT_ENABLED = Boolean.parseBoolean(L2JModSettings.getProperty("RankCraftEnabled", "false"));
					RANK_CRAFT_INTERVAL = Integer.parseInt(L2JModSettings.getProperty("RankCraftInterval", "120"));
					RANK_CRAFT_REWARD_ID = Integer.parseInt(L2JModSettings.getProperty("RankCraftRewardId", "57"));
					RANK_CRAFT_REWARD_COUNT = Integer.parseInt(L2JModSettings.getProperty("RankCraftRewardCount", "100"));
					
					RANK_TVT_ENABLED = Boolean.parseBoolean(L2JModSettings.getProperty("RankTvTEnabled", "false"));
					RANK_TVT_INTERVAL = Integer.parseInt(L2JModSettings.getProperty("RankTvTInterval", "120"));
					RANK_TVT_REWARD_ID = Integer.parseInt(L2JModSettings.getProperty("RankTvTRewardId", "57"));
					RANK_TVT_REWARD_COUNT = Integer.parseInt(L2JModSettings.getProperty("RankTvTRewardCount", "100"));
...
CHAT_SHOUT = Boolean.parseBoolean(L2JModSettings.getProperty("ChatShout", "False"));
 PVPS_TO_USE_CHAT_SHOUT = Integer.parseInt(L2JModSettings.getProperty("PvpsToUseChatShout", "30"));
 CHAT_TRADE = Boolean.parseBoolean(L2JModSettings.getProperty("ChatTrade", "False"));
 PVPS_TO_USE_CHAT_TRADE = Integer.parseInt(L2JModSettings.getProperty("PvpsToUseChatTrade", "30"));

RAID_MAX_DISTANCE_FROM_SPAWN = Integer.parseInt(L2JModSettings.getProperty("RaidMaxDistanceFromSpawn", "0"));
...
CUSTOM_SUBCLASS_LVL = Integer.parseInt(L2JModSettings.getProperty("CustomSubclassLvl", "40"));
 ...
 ALLOW_CUSTOM_STARTER_ITEMS = Boolean.parseBoolean(L2JModSettings.getProperty("AllowCustomStarterItems", "false"));
  ...
  {
  L2JModSettings.getProperty("CustomStarterItems", "0,0").split(";");
 ...
 SPAWN_Z = Integer.parseInt(L2JModSettings.getProperty("SpawnZ", ""));
			...
			MAX_LEVEL_FOR_AQ_ZONE = Integer.parseInt(grandbossSettings.getProperty("MaxLevelToEnter", "50"));
				...
				BUFF_PEACE = Boolean.parseBoolean(CommunityBoardPvPSettings.getProperty("BuffPeace", "true")); 
				MANI_BUFF = Boolean.parseBoolean(CommunityBoardPvPSettings.getProperty("ManiBuff", "true")); 
				TOP_PLAYER_ROW_HEIGHT = Integer.parseInt(CommunityBoardPvPSettings.getProperty("TopPlayerRowHeight", "19"));				
				TOP_PLAYER_RESULTS = Integer.parseInt(CommunityBoardPvPSettings.getProperty("TopPlayerResults", "20"));
				RAID_LIST_ROW_HEIGHT = Integer.parseInt(CommunityBoardPvPSettings.getProperty("RaidListRowHeight", "18"));
				RAID_LIST_RESULTS = Integer.parseInt(CommunityBoardPvPSettings.getProperty("RaidListResults", "20"));
				RAID_LIST_SORT_ASC = Boolean.parseBoolean(CommunityBoardPvPSettings.getProperty("RaidListSortAsc", "True"));
				ALLOW_REAL_ONLINE_STATS = Boolean.parseBoolean(CommunityBoardPvPSettings.getProperty("AllowRealOnlineStats", "True"));
				REGION_LOAD_TIMER = Integer.parseInt(CommunityBoardPvPSettings.getProperty("ReloadCommunityRegionTimer", "2"));
				ENABLE_GM_SHOP_CB = Boolean.parseBoolean(CommunityBoardPvPSettings.getProperty("EnableGmShop", "True"));
				ONLY_USE_SHOP_PEACE_ZONE = Boolean.parseBoolean(CommunityBoardPvPSettings.getProperty("OnlyUseGmShopPeaceZone", "True"));
				ENABLE_GK_GLOBAL_CB = Boolean.parseBoolean(CommunityBoardPvPSettings.getProperty("EnableGkGlobal", "True"));
				ONLY_USE_GK_PEACE_ZONE = Boolean.parseBoolean(CommunityBoardPvPSettings.getProperty("OnlyUseGkGlobalPeaceZone", "True"));
				ENABLE_BUFFER_CB = Boolean.parseBoolean(CommunityBoardPvPSettings.getProperty("EnableBuffer", "True"));
				ONLY_USE_BUFFER_PEACE_ZONE = Boolean.parseBoolean(CommunityBoardPvPSettings.getProperty("OnlyUseBufferPeaceZone", "True"));
				ENABLE_CLASS_MASTER_CB = Boolean.parseBoolean(CommunityBoardPvPSettings.getProperty("EnableClassMaster", "True"));
				ONLY_USE_CLASS_MASTER_PEACE_ZONE = Boolean.parseBoolean(CommunityBoardPvPSettings.getProperty("OnlyUseClasMasterPeaceZone", "True"));
				ENABLE_AUGMENT_CB = Boolean.parseBoolean(CommunityBoardPvPSettings.getProperty("AugmentWeapon", "True"));
				ONLY_USE_AUGMENT_PEACE_ZONE = Boolean.parseBoolean(CommunityBoardPvPSettings.getProperty("OnlyUseAugmentPeaceZone", "True"));
				ENABLE_HOME = Boolean.parseBoolean(CommunityBoardPvPSettings.getProperty("EnableHome", "True"));
				ENABLE_FAVORITE = Boolean.parseBoolean(CommunityBoardPvPSettings.getProperty("EnableFavorite", "True"));
				ENABLE_HOMEPAGE = Boolean.parseBoolean(CommunityBoardPvPSettings.getProperty("EnableHomePage", "True"));
				ENABLE_REGION = Boolean.parseBoolean(CommunityBoardPvPSettings.getProperty("EnableRegion", "True"));
				ENABLE_CLAN = Boolean.parseBoolean(CommunityBoardPvPSettings.getProperty("EnableClan", "True"));
				ENABLE_MAIL = Boolean.parseBoolean(CommunityBoardPvPSettings.getProperty("EnableMail", "True"));
				ENABLE_FRIENDS = Boolean.parseBoolean(CommunityBoardPvPSettings.getProperty("EnableFriend", "True"));

				CB_SKILLS_PROPHET = new FastMap<>();
				for (String st : CommunityBoardPvPSettings.getProperty("SkillsProphet").split(";"))
				{
					int skill, level;
					try
					{
						skill = Integer.valueOf(st.split(",")[0]);
						level = Integer.valueOf(st.split(",")[1]);

						CB_SKILLS_PROPHET.put(skill, level);
					}
					catch (NumberFormatException nfe)
					{
						nfe.printStackTrace();
				...
				CB_SKILLS_ELDER = new FastMap<>();
				for (String st : CommunityBoardPvPSettings.getProperty("SkillsElder").split(";"))
				{
					int skill, level;
					try
					{
						...
						CB_SKILLS_ELDER.put(skill, level);
					}
					catch (NumberFormatException nfe)
					{
						nfe.printStackTrace();
				...
				CB_SKILLS_S_ELDER = new FastMap<>();
				for (String st : CommunityBoardPvPSettings.getProperty("SkillsShillienElder").split(";"))
				{
					int skill, level;
					try
					{
						...
						CB_SKILLS_S_ELDER.put(skill, level);
					}
					catch (NumberFormatException nfe)
					{
						nfe.printStackTrace();
				...
				CB_SKILLS_OVERLORD = new FastMap<>();
				for (String st : CommunityBoardPvPSettings.getProperty("SkillsOverlord").split(";"))
				{
					int skill, level;
					try
					{
						...
						CB_SKILLS_OVERLORD.put(skill, level);
					}
					catch (NumberFormatException nfe)
					{
						nfe.printStackTrace();
				...
				CB_SKILLS_WARCRY = new FastMap<>();
				for (String st : CommunityBoardPvPSettings.getProperty("SkillsWarcry").split(";"))
				{
					int skill, level;
					try
					{
						...
						CB_SKILLS_WARCRY.put(skill, level);
					}
					catch (NumberFormatException nfe)
					{
						nfe.printStackTrace();
				...
				CB_SKILLS_B_DANCER = new FastMap<>();
				for (String st : CommunityBoardPvPSettings.getProperty("SkillsBladeDancer").split(";"))
				{
					int skill, level;
					try
					{
						...
						CB_SKILLS_B_DANCER.put(skill, level);
					}
					catch (NumberFormatException nfe)
					{
						nfe.printStackTrace();
				...
				CB_SKILLS_S_SINGER = new FastMap<>();
				for (String st : CommunityBoardPvPSettings.getProperty("SkillsSwordSinger").split(";"))
				{
					int skill, level;
					try
					{
						...
						CB_SKILLS_S_SINGER.put(skill, level);
					}
					catch (NumberFormatException nfe)
					{
						nfe.printStackTrace();
				...
				CB_SKILLS_OTHER = new FastMap<>();
				for (String st : CommunityBoardPvPSettings.getProperty("SkillsOther").split(";"))
				{
					int skill, level;
					try
					{
						...
						CB_SKILLS_OTHER.put(skill, level);
					}
					catch (NumberFormatException nfe)
					{
						nfe.printStackTrace();

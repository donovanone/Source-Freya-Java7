...
public abstract class L2GameServerPacket extends SendablePacket<L2GameClient>
{
	...
	protected void write()
	{
		...
		{
			_log.log(Level.SEVERE, "Client: " + getClient().toString() + " - Failed writing: " + getClass().getSimpleName() + " - Donovan Server Version: " + Config.SERVER_VERSION + " - DP Revision: " + Config.DATAPACK_VERSION + " ; " + e.getMessage(), e);
		}
	}

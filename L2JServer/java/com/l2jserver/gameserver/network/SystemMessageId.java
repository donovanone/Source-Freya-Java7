...
public final class SystemMessageId
{
	...
	/**
	 * ID: 2774<br>
	 * Console Message: You can make another report in $s1-minute(s). You have
	 * $s2 points remaining on this account.
	 */
	...
	public static SystemMessageId EARNED_ITEM;

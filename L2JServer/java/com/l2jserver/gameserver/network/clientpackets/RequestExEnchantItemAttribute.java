...
public class RequestExEnchantItemAttribute extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (item.getItem().getItemType() == L2WeaponType.FISHINGROD || item.isShadowItem() || (item.isPvp() && !Config.ENABLE_PVP_WEAPON_ELEMENT) || (item.isHeroItem() && !Config.ENABLE_HERO_WEAPON_ELEMENT) || item.isTimeLimitedItem() ||

...
public class MultiSellChoose extends L2GameClientPacket
{
	...
	public void runImpl()
	{
        ...
        if (!player.getUsingCommunity() && !player.isGM() && ((target == null) || !list.checkNpcObjectId(target.getObjectId()) || !target.canInteract(player)))
        {
            player.setMultiSell(null);
            player.setUsingCommunity(false); // TODO sera necesario aplicar la consulta sobre el estado?
            return;
        }

...
public class Config extends DocumentParser
{
	...
	public void load()
	{
		...
		_log.info("[Event Manager]: System initialized.");
		_log.info("[Event Manager]: Configuration Files Loaded. ");
	}
			...
			if ("events".equalsIgnoreCase(n.getNodeName()))
			{
				for (Node d = n.getFirstChild(); d != null; d = d.getNextSibling())
				{
					if ("event".equalsIgnoreCase(d.getNodeName()))
					{
						...
						int eventId =Integer.parseInt(attrs.getNamedItem("id").getNodeValue());
						...
						for (Node c = d.getFirstChild(); c != null; c = c.getNextSibling())
						{
							...
							if ("color".equalsIgnoreCase(c.getNodeName()))
							{
								attrs = c.getAttributes();
								String owner = parseString(attrs, "owner");
								int r = Integer.parseInt(attrs.getNamedItem("r").getNodeValue());
								int g = Integer.parseInt(attrs.getNamedItem("g").getNodeValue());
								int b = Integer.parseInt(attrs.getNamedItem("b").getNodeValue());

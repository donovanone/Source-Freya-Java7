...
import com.l2jserver.gameserver.phoenix.Main;

import net.vortextengine.VoteMain;
...
import com.l2jserver.gameserver.datatables.ModsBufferSkillTable;
...
import com.l2jserver.gameserver.instancemanager.votereward.VoteManager;
...
import com.l2jserver.gameserver.model.entity.PcPoint;
	...
	BonusExpManager.getInstance();
		...
		Runtime.getRuntime().addShutdownHook(Shutdown.getInstance());
				if(Config.SELL_BUFF_ENABLED)
					{
						_log.info("Sell Buff System : enabled");
					}
		...
		// Event phoenix
		printSection("Load Phoenix Event");
		Main.main();

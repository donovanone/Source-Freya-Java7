...
public abstract class L2Skill implements IChanceSkillTrigger, IIdentifiable
{
	...
	public static final int SKILL_DIVINE_INSPIRATION1 = 551405;
					...
					for (L2Character obj : objs)
					{
						if (obj instanceof L2Attackable || obj instanceof L2Playable)
						{
							...
							if(obj instanceof L2PcInstance) 
							 	if(EventsInterface.isParticipating(sourcePlayer.getObjectId()) && EventsInterface.isParticipating(obj.getObjectId())) 
							 		if(EventsInterface.areTeammates(obj.getObjectId(), sourcePlayer.getObjectId())) 
							 			continue; 
							 
							if(activeChar instanceof L2PcInstance)	
							 if(obj instanceof L2Summon) 
								 if(EventsInterface.isParticipating(sourcePlayer.getObjectId()) && EventsInterface.isParticipating(((L2Summon)obj).getOwner().getObjectId())) 
									 if(EventsInterface.areTeammates(((L2Summon)obj).getOwner().getObjectId(), sourcePlayer.getObjectId())) 
										 continue;

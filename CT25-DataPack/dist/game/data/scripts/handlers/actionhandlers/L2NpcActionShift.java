...
public class L2NpcActionShift implements IActionHandler
{
	...
	public boolean action(L2PcInstance activeChar, L2Object target, boolean interact)
	{
		...
		if (activeChar.getAccessLevel().isGm())
		{
			...
			{
				html.replace("%butt%", "<button value=\"Loja\" action=\"bypass -h admin_showShop " + String.valueOf(((L2Npc) target).getTemplate().getId()) + "\" width=60 height=21 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">");
			}
			else
			{
				html.replace("%butt%", "");
